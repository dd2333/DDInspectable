#
#  Be sure to run `pod spec lint DDInspectable.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "daodao"
  # s.authors            = { "daodao" => "526151860@qq.com" }
  # s.social_media_url   = "http://twitter.com/daodao"
